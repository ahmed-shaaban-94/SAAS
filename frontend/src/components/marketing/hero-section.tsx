      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-text-secondary sm:text-xl">
            Import, clean, analyze, and visualize your sales data with an
            automated medallion pipeline. From Excel chaos to actionable
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <a
              href="#how-it-works"
              className="w-full rounded-lg border border-border bg-card/50 px-8 py-3 text-center text-sm font-semibold text-text-primary transition-colors hover:bg-card sm:w-auto"
            >
              See How It Works
            </a>
          </div>
