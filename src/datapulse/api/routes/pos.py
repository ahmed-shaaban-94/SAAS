...
_receipt_email_idempotency_dep = _pos_routes_deps._receipt_email_idempotency_dep
_receipt_whatsapp_idempotency_dep = _pos_routes_deps._receipt_whatsapp_idempotency_dep
